...
export function RecipeSuggestions() {
  ...
  return <div className={styles.shell}><nav className={styles.nav}><strong>Neverita · Recetas</strong><a href="/app">Inventario</a></nav><main className={styles.main}>
    <header><p className={styles.eyebrow}>Con lo que ya tienes</p><h1>Ideas para cocinar hoy</h1><p className={styles.lede}>Comparamos tu inventario en el servidor y te mostramos qué puedes preparar y qué te falta.</p></header>
