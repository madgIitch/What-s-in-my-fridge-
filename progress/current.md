...
La propuesta aprobada está en `docs/design/SPRINT13_PROPOSAL.md`. Se implementó navegación principal compartida responsive con estado activo semántico y target táctil mínimo, más `/app/settings` como hub para favoritos, compra, importación y Pro. El Sprint 12 figura `done` por cierre administrativo, con ensayo de staging pendiente y límites registrados en su review; Sprint 13 prueba la interfaz con fixtures sintéticos.
