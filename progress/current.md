...
- Verificar mapping Auth contra staging y bucket Firebase real, ejecutar captura e inventario Storage, aplicar la migración SQL e importar/reconciliar en staging. Si aparecen objetos referenciados, implementar su copia controlada.
